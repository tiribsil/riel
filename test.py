...
class TestListaExamesRealizados(unittest.TestCase):
    def setUp(self):
        ...
        def test_multipla_insercao_lista(self):
            self.lista.arquivo_historico.inserir(self.registros[9])
            self.lista.arquivo_historico.inserir(self.registros[1])
            self.assertEqual(str(self.registros[9]) + str(self.registros[1]), self.lista.arquivo_historico)

        def test_inserir_lista(self):
            self.lista.arquivo_historico.inserir(self.registros[4])
            self.assertEqual(str(self.registro[4]), self.lista.arquivo_historico)

        def test_limpar_lista(self):
            self.lista.arquivo_historico.inserir(self.registros[3])
            self.lista.arquivo_historico.inserir(self.registros[5])
            self.lista.arquivo_historico.inserir(self.registros[7])
            self.lista.arquivo_historico.limpar()
            self.assertEqual(os.path.getsize(self.lista.arquivo_historico), 0)
